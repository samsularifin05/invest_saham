...
// require('./pwa-services.js')
let bootstrap = require('../vendor/bootstrap-5/js/bootstrap.bundle.js')
let Swiper =  require('../vendor/swiperjs-6.6.2/swiper-bundle.min.js')
let ProgressBar = require('../vendor/progressbar-js/progressbar.min.js')
...
$(window).on('load', function () {
    ...
    switch (body.attr('data-page')) {
        ...
        case "index":
            ...
            /* Progress circle */
            // console.log(circleprogressone)
            // if(circleprogressone!= undefined){
